...
* `$args` is a array of arguments for this post status, the same as for `register_post_status` plus `post_type` argument, which should be array of post types or a string of a post type where post status should be registered.
